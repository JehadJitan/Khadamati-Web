        ...
        <div className='form-content-right'>
            <form className='form' onSubmit={handleSubmit} noValidate>
                ...
                <div className='form-inputs'>
                    ...
                    <input type='text' name='username' className='form-input' placeholder='ادخل اسم المستخدم' id='username' value={values.username} onChange={handleChange} />
                ...
                <div className='form-inputs'>
                    ...
                    <input type='password' name='password' className='form-input' placeholder='ادخل كلمة المرور' id='password' value={values.password} onChange={handleChange} />
                    {errors.password && <p>{errors.password}</p>}
                </div>
                <button className='form-input-btn' type='submit' onClick={() => { history.push("/DB"); }}>تسجيل الدخول</button>

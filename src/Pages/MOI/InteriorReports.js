  ...
  return (
    <TitleDiv>
      ...
      <StyledReport>
        ...
        <Stack direction="row" style={{ marginTop: "3%" }}>
          <Button
            variant="contained"
            color="error"
            style={{ "font-family": "Almarai" }}
